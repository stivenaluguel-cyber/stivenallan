...
// Galeria com lightbox compartilhada entre as páginas de empreendimento Eraldo
// (promovida a partir do padrão criado no Aura Residence). trackPlantas é um objeto
// serializável (não uma função) porque as páginas que a usam são Server Components —
// nunca é possível passar callback direto para um client component nesse caso.
