...
const EMPREENDIMENTOS = [
  ...
  { id: '5', nome: 'Tremezzo Residencial', slug: 'tremezzo-residencial-centro-criciuma-sc', construtora_slug: 'fontana', construtora: 'Construtora Fontana', bairro: 'Centro', cidade: 'Criciúma', uf: 'SC', status: 'em obras', exibir_preco: false, preco: null, frase: 'Celebre o inesquecível no coração de Criciúma.', img: 'https://drive.google.com/uc?export=view&id=1tzgFeAyXCBdkZ1XII2rgJKXAlDz2RcLK' },
]
      ...
      <Link href={href} style={{ textDecoration: 'none', color: 'inherit', display: 'block' }}>
        ...
        <div style={{ padding: '20px 22px 22px', background: t.bg, borderBottom: `1px solid ${t.line}` }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
            ...
            <a href={wpp} target="_blank" rel="noopener noreferrer" style={{ width: 36, height: 36, borderRadius: '50%', background: '#25D366', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0 }} aria-label={`WhatsApp sobre ${emp.nome}`}>
