...
const PORTFOLIO_FALLBACK = [
  ...
  { id: '3', nome: 'Pineto Residencial', slug: 'pineto-centro-criciuma-sc', construtora_slug: 'fontana', construtora_nome: 'Construtora Fontana', bairro: 'Centro', cidade: 'Criciúma', uf: 'SC', regiao: 'cidade', status_obra: 'lancamento', area_min: 75, area_max: 76, exibir_preco: true, preco_a_partir_de: 619250, frase: 'Na planta no Centro de Criciúma, com financiamento direto com a construtora.', imagem_capa_url: 'https://images.unsplash.com/photo-1600585154340-be6161a56a0c?auto=format&fit=crop&w=700&q=80' },
]
