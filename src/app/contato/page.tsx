    ...
    <main style={{ background: '#121315', minHeight: '100vh', color: '#fff', fontFamily: 'var(--font-public-sans), system-ui, sans-serif' }}>
      <section style={{ padding: '80px 24px 40px', maxWidth: 1100, margin: '0 auto' }}>
        ...
        <div style={{ textAlign: 'center', maxWidth: 600, margin: '0 auto' }}>
          <p style={{ fontSize: 13, letterSpacing: '0.12em', color: '#D24E22', textTransform: 'uppercase', marginBottom: 16 }}>Atendimento personalizado</p>
          <h1 style={{ fontSize: 'clamp(2rem, 5vw, 3rem)', fontWeight: 800, marginBottom: 16, fontFamily: 'var(--font-piazzolla), Georgia, serif' }}>Fale com o Corretor</h1>
      ...
      <section style={{ padding: '0 24px 80px', maxWidth: 1100, margin: '0 auto' }}>
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(260px, 1fr))', gap: 24 }}>
          {[
            ...
            { titulo: 'Telefone', desc: 'Prefere falar? Ligue diretamente.', label: '(48) 99164-2332', href: 'tel:+5548991642332', cor: '#D24E22', cta: 'Ligar agora' },
          ].map((c, i) => (
            <a key={i} href={c.href} target="_blank" rel="noopener noreferrer" style={{ display: 'block', background: '#202327', borderRadius: 16, padding: '32px 24px', border: '1px solid #2e3338', textDecoration: 'none', color: '#fff' }}>
              <h2 style={{ fontSize: 22, fontWeight: 700, marginBottom: 8, color: c.cor, fontFamily: 'var(--font-piazzolla), Georgia, serif' }}>{c.titulo}</h2>
      ...
      <section style={{ background: '#1a1c1f', padding: '80px 24px', borderTop: '1px solid #2e3338' }}>
        <div style={{ maxWidth: 1100, margin: '0 auto', display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: 48 }}>
          <div>
            <h2 style={{ fontSize: '1.8rem', fontWeight: 800, marginBottom: 28, fontFamily: 'var(--font-piazzolla), Georgia, serif' }}>Informacoes de contato</h2>
            <div style={{ display: 'flex', flexDirection: 'column', gap: 18 }}>
              {[
                ...
                <div key={i} style={{ display: 'flex', gap: 12, alignItems: 'flex-start' }}>
                  <div style={{ width: 6, height: 6, minWidth: 6, borderRadius: '50%', background: '#D24E22', marginTop: 7 }} />
                  <div>
          ...
          <div style={{ background: '#202327', borderRadius: 16, padding: 36, border: '1px solid #2e3338', textAlign: 'center' }}>
            <h3 style={{ fontSize: 20, fontWeight: 700, marginBottom: 12, fontFamily: 'var(--font-piazzolla), Georgia, serif' }}>Pronto para comprar seu imovel?</h3>
      ...
      <section style={{ padding: '80px 24px', maxWidth: 760, margin: '0 auto' }}>
        <h2 style={{ fontSize: 'clamp(1.6rem, 3vw, 2.2rem)', fontWeight: 800, textAlign: 'center', marginBottom: 40, fontFamily: 'var(--font-piazzolla), Georgia, serif' }}>Perguntas frequentes</h2>
        <div style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
          {faqs.map((f, i) => (
            <div key={i} style={{ background: '#202327', borderRadius: 12, padding: '22px 26px', border: '1px solid #2e3338' }}>
              <h3 style={{ fontSize: 15, fontWeight: 700, marginBottom: 8, color: '#D24E22', fontFamily: 'var(--font-piazzolla), Georgia, serif' }}>{f.q}</h3>
