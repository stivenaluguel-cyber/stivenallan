...
<p className="mt-serif" style={{ color: t.onDarkMuted, fontSize: 'clamp(18px,2.4vw,26px)', marginTop: 18, marginBottom: 60 }}>Negociação direta com a construtora, sem intermediários.</p>
