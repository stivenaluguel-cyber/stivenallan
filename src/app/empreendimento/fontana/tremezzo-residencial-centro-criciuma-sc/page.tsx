...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    locale: 'pt_BR',
    type: 'website',
    images: [{ url: 'https://drive.google.com/uc?export=view&id=1tzgFeAyXCBdkZ1XII2rgJKXAlDz2RcLK', width: 1200, height: 630 }],
  },
  twitter: {
    ...
    images: ['https://drive.google.com/uc?export=view&id=1tzgFeAyXCBdkZ1XII2rgJKXAlDz2RcLK'],
  },
  robots: { index: true, follow: true },
}
const RENDERS = [
  { src: 'https://drive.google.com/uc?export=view&id=1tzgFeAyXCBdkZ1XII2rgJKXAlDz2RcLK', alt: 'Tremezzo Residencial — fachada principal', label: 'Fachada' },
  { src: 'https://drive.google.com/uc?export=view&id=1g9afEAHK0jHFdwjATu0NQNR-RHb0XJ5M', alt: 'Tremezzo Residencial — perspectiva exterior', label: 'Perspectiva' },
  { src: 'https://drive.google.com/uc?export=view&id=1UJt4R_9PgpUm3GMFRoYnTXU7SyVthYAB', alt: 'Tremezzo Residencial — vista geral', label: 'Vista geral' },
  { src: 'https://drive.google.com/uc?export=view&id=1sAi2MrrSvv81n-0rXdD5UUvP2yvIGfk_', alt: 'Tremezzo Residencial — fachada lateral', label: 'Fachada lateral' },
  { src: 'https://drive.google.com/uc?export=view&id=11pQk-K--lBt3G4ob4vzc8eI_iFDNhM8E', alt: 'Tremezzo Residencial — detalhe arquitetônico', label: 'Detalhe' },
  { src: 'https://drive.google.com/uc?export=view&id=15q1c6rVrgvuywQ6SdRsWDtnVcXT8qSoB', alt: 'Tremezzo Residencial — área externa', label: 'Área externa' },
  { src: 'https://drive.google.com/uc?export=view&id=1zwMSHa-Ja6MGdlC2lq9fxQU7plgxHBLo', alt: 'Tremezzo — piscina adulto render', label: 'Piscina adulto' },
  { src: 'https://drive.google.com/uc?export=view&id=1LXRWetoAesYcsX9Z147NG5a6v_1MGR5x', alt: 'Tremezzo — área de lazer render', label: 'Lazer' },
  { src: 'https://drive.google.com/uc?export=view&id=1eU-TvLidHnIJ6fVfD-vZV79eQxjYW1wM', alt: 'Tremezzo — fitness render', label: 'Fitness' },
  { src: 'https://drive.google.com/uc?export=view&id=1_JkJJQdhrpqu2-21VipzXbhA00ODkIyd', alt: 'Tremezzo — coworking render', label: 'Coworking' },
  { src: 'https://drive.google.com/uc?export=view&id=1Y0YSrz60_PHy0NJKLWlIklGgaN3Y-EYC', alt: 'Tremezzo — salão de festas render', label: 'Salão de festas' },
  { src: 'https://drive.google.com/uc?export=view&id=1_JKSBGU6bogh2mWM6J8hjxKpqrzYjzRL', alt: 'Tremezzo — jardim render', label: 'Jardim' },
  { src: 'https://drive.google.com/uc?export=view&id=1bWFhCE1vy7pjxqcnXRe_1h1bGzAN0XVi', alt: 'Tremezzo — terraço render', label: 'Terraço' },
  { src: 'https://drive.google.com/uc?export=view&id=1ugaXCwmuBrKEaF6FBmK11cE5jgjRi4p_', alt: 'Tremezzo — quiosque BBQ render', label: 'Quiosque BBQ' },
  { src: 'https://drive.google.com/uc?export=view&id=1eqfZOe6u4lkrdDuQksBZfZtALcytpRLa', alt: 'Tremezzo — playground render', label: 'Playground' },
  { src: 'https://drive.google.com/uc?export=view&id=1P38Lxc2qz_TNPYSCBg1OCSKyuic1nLg1', alt: 'Tremezzo — espaço pet render', label: 'Espaço pet' },
  { src: 'https://drive.google.com/uc?export=view&id=1xmEp4hjaujYYcoHvgLp7vhpZ8qrehxSY', alt: 'Tremezzo — brinquedoteca render', label: 'Brinquedoteca' },
  { src: 'https://drive.google.com/uc?export=view&id=1kPBhgd9fKOnFNtld1VrUREmU_O_zhZgO', alt: 'Tremezzo — sala de jogos render', label: 'Sala de jogos' },
  { src: 'https://drive.google.com/uc?export=view&id=1x914XE1ccVmLnUoM7F8Df6h4c85-9pJH', alt: 'Tremezzo — render área comum', label: 'Área comum' },
  { src: 'https://drive.google.com/uc?export=view&id=17kPkJxoXpQh1AggivjZGTwr-8_bSuI-u', alt: 'Tremezzo — render área de lazer', label: 'Área de lazer' },
  { src: 'https://drive.google.com/uc?export=view&id=1UzTzNisPdmEp6325oRjxCJB4zZJHXZae', alt: 'Tremezzo — render área social', label: 'Área social' },
  { src: 'https://drive.google.com/uc?export=view&id=1COeweim5wRugw9oLBJ9JbcH42rvwjCNu', alt: 'Tremezzo — render área gourmet', label: 'Área gourmet' },
  { src: 'https://drive.google.com/uc?export=view&id=1H4xGsrk1_xYpi8jZPowW6LxfhRdXm0Hz', alt: 'Tremezzo — vista noturna render', label: 'Vista noturna' },
  { src: 'https://drive.google.com/uc?export=view&id=1DDLQmXlzGCipAfJniuhbrE4I4ODXsG9v', alt: 'Tremezzo — sacada gourmet render', label: 'Sacada gourmet' },
  { src: 'https://drive.google.com/uc?export=view&id=1aiw6SZXMZxhIZ9BLisK1pXjYwiuLtCb6', alt: 'Tremezzo — living integrado render', label: 'Living integrado' },
  { src: 'https://drive.google.com/uc?export=view&id=12lEdyYLbfr2iGixI1zYdHpR1SWYj1Yfd', alt: 'Tremezzo — perspectiva geral render', label: 'Perspectiva geral' },
]

const GALERIA = [
  { src: 'https://drive.google.com/uc?export=view&id=18HE4iwX3yyHWSrwmdDy7Bh24cV5bXfds', alt: 'Tremezzo decorado — sala de estar', label: 'Sala de estar' },
  { src: 'https://drive.google.com/uc?export=view&id=1qFS3jO4QLO3NYiti72txNScf3OKYEEPr', alt: 'Tremezzo decorado — living integrado', label: 'Living' },
  { src: 'https://drive.google.com/uc?export=view&id=1JQC2OHVfewNqodtfgiqbCZS08AxjNl5B', alt: 'Tremezzo decorado — cozinha quartzito', label: 'Cozinha' },
  { src: 'https://drive.google.com/uc?export=view&id=1IOn-JOwk8gnrSPgmgDEwCupYVooALGAF', alt: 'Tremezzo decorado — suíte master', label: 'Suíte master' },
  { src: 'https://drive.google.com/uc?export=view&id=1Ko3ZZpNQ0O30hMqN_rRVZutxgVdoNCmr', alt: 'Tremezzo decorado — dormitório', label: 'Dormitório' },
  { src: 'https://drive.google.com/uc?export=view&id=1OTUk2uARjk3i92cCnqY7lVckkvee9aYY', alt: 'Tremezzo decorado — sacada gourmet churrasqueira', label: 'Sacada gourmet' },
  { src: 'https://drive.google.com/uc?export=view&id=1s5g57AZBwvSPs6FVmu5O4MMoP9xCMyFx', alt: 'Tremezzo decorado — banheiro', label: 'Banheiro' },
  { src: 'https://drive.google.com/uc?export=view&id=18w2x6MEefc844FYB-ngVVC7GTLQHvicT', alt: 'Tremezzo decorado — lavanderia independente', label: 'Lavanderia' },
  { src: 'https://drive.google.com/uc?export=view&id=1PNmTx_2w0n_fHE4_gdjusi1HAzI2K9I_', alt: 'Tremezzo decorado — varanda', label: 'Varanda' },
  { src: 'https://drive.google.com/uc?export=view&id=1fOCMDkxomAmTB07Tm4RAM1RojVrKMkZM', alt: 'Tremezzo decorado — área gourmet', label: 'Área gourmet' },
  { src: 'https://drive.google.com/uc?export=view&id=19isrU_y2eH8YW2_qLM5vxKstj_Fex2oB', alt: 'Tremezzo decorado — porcelanato retificado', label: 'Acabamento' },
  { src: 'https://drive.google.com/uc?export=view&id=1Ag_2wRbJMA7-sZSie1B_CCj84_JQatqM', alt: 'Tremezzo decorado — vista privilegiada', label: 'Vista privilegiada' },
]
...
const SCHEMA = JSON.stringify({
  ...
  "@graph": [
    { "@type": "Apartment", "name": "Tremezzo Residencial",
      ...
      "floorSize": { "@type": "QuantitativeValue", "value": 125, "unitCode": "MTK" }, "numberOfRooms": 3 },
    { "@type": "RealEstateAgent", "name": "Stiven Allan", "telephone": "+5548991642332",
      "areaServed": ["Criciúma", "Içara", "Balneário Piçarras", "Balneário Rincão"] }
  ]
})
