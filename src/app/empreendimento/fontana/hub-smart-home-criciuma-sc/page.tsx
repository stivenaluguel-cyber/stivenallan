...
export const metadata: Metadata = {
  ...
  authors: [{ name: 'Stiven Allan', url: 'https://stivenallan.com.br' }],
  creator: 'Stiven Allan — CRECI 60.275',
  alternates: { canonical: 'https://stivenallan.com.br/empreendimento/fontana/hub-smart-home-criciuma-sc' },
  openGraph: {
    ...
    url: 'https://stivenallan.com.br/empreendimento/fontana/hub-smart-home-criciuma-sc',
  ...
  '@graph': [
    {
      ...
      url: 'https://stivenallan.com.br/empreendimento/fontana/hub-smart-home-criciuma-sc',
      offers: { '@type': 'Offer', priceCurrency: 'BRL', availability: 'https://schema.org/InStock', seller: { '@type': 'RealEstateAgent', name: 'Stiven Allan', identifier: 'CRECI 60.275', telephone: '+5548991642332', url: 'https://stivenallan.com.br' } },
    ...
    },
    {
      ...
      itemListElement: [
        ...
        { '@type': 'ListItem', position: 3, name: 'Hub Smart Home', item: 'https://stivenallan.com.br/empreendimento/fontana/hub-smart-home-criciuma-sc' },
      ],
    },
    {
      '@type': 'FAQPage',
