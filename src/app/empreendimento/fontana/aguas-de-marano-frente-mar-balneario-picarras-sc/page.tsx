...
// All lightbox images: gallery + lazer piscina
const LB_IMGS = [
...GALERIA,
{ src: IMG.piscina, alt: 'Piscina adulto com wet bar do Águas de Marano Residencial', label: 'Lazer — Piscina' },
]
...
.am-gcard { position: relative; overflow: hidden; cursor: zoom-in; }
...
.am-lazer-card { position: relative; overflow: hidden; cursor: zoom-in; }
...
>
<Image src={IMG.piscina} alt="Piscina adulto com wet bar do Águas de Marano Residencial" fill loading="lazy" sizes="(max-width: 768px) 100vw, 55vw" style={{ objectFit: 'cover' }} />
</div>
