...
{ src: 'https://lh3.googleusercontent.com/d/1IsOLxs0ZGR8wcN6VlToFGfq-mOwEaM79', alt: 'Academia Mar di Arienzo Residencial', label: 'Academia' },
{ src: 'https://lh3.googleusercontent.com/d/1u7_GKvjGSzrW5xJkbQEuAOsPGid2N02W', alt: 'Brinquedoteca Mar di Arienzo', label: 'Brinquedoteca' },
{ src: 'https://lh3.googleusercontent.com/d/1X6OCCPhkw22nUsrIkxOgVTZ5D2zH0NIo', alt: 'Living integrado Mar di Arienzo', label: 'Living Integrado' },
{ src: 'https://lh3.googleusercontent.com/d/1x5KX09EmtYaDxQx0EOs9HG1hEPWOZV1c', alt: 'Embasamento Mar di Arienzo Residencial', label: 'Embasamento' },
{ src: 'https://lh3.googleusercontent.com/d/15kwxXKV9wIHTqE4lnYH0YYgd-H-2rXyi', alt: 'Vista aérea Mar di Arienzo Balneário Rincão', label: 'Vista Aérea' },
]
const DIFERENCIAIS = [
...
<a href={CATALOGO_PDF} target="_blank" rel="noopener noreferrer" className="ma-cta ma-cta-light">Baixar Catálogo &amp; Plantas</a>
</div>
</section>
