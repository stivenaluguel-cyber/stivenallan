...
const GALERIA: LightboxPhoto[] = [
  ...
  { src: 'https://lh3.googleusercontent.com/d/1fuaQqaIB4tKE3MnJ1aoM844tjYPK03_J', label: 'Fazendinha' },
  { src: 'https://lh3.googleusercontent.com/d/1K9zGxd7UUeVWlHNbvLOJjg6N0yemKGsR', label: 'Espaço Fogo' },
  { src: 'https://lh3.googleusercontent.com/d/1bLO6lwgOIzKlPBh9w0gObg26OsZqVTWI', label: 'Quiosque Fogo de Chão' },
  { src: 'https://lh3.googleusercontent.com/d/1Ww2fnC2XbxU11bYCfgJmp8lgBDnCmQVS', label: 'Salão de Festas' },
  { src: 'https://lh3.googleusercontent.com/d/1GtsVsVBymDJbkANbTq7y2635j_YKvlLD', label: 'Sala de Jogos' },
  { src: 'https://lh3.googleusercontent.com/d/1lLc2kb0cn4mbS_e7ncNywVm4f1h52Mq0', label: 'Playground' },
  { src: 'https://lh3.googleusercontent.com/d/10AN3DEOIETYovjPYjxO68jhcJ-A3X-R5', label: 'Brinquedoteca' },
  { src: 'https://lh3.googleusercontent.com/d/1T08UNXa_wa7pdQir-5-yjyJZUCZVb7hu', label: 'Quadra Poliesportiva' },
  { src: 'https://lh3.googleusercontent.com/d/1m6Op_V-E2E1cBpnTEpGuwpB9ypizC_tj', label: 'Quadra de Tênis' },
