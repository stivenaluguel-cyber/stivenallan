...
const FAQ_ITEMS = [
  { pergunta: 'Como funciona o pagamento do Rocca Pietore Residencial?', resposta: 'Condições de pagamento sob consulta. Fale com um corretor para receber a composição comercial e a disponibilidade atualizadas.' },
  ...
  { pergunta: 'Onde fica o Rocca Pietore Residencial?', resposta: 'O Rocca Pietore Residencial está localizado na Rua Siderúrgica, no Centro de Siderópolis/SC.' },
  { pergunta: 'Quais as plantas e metragens disponíveis?', resposta: 'O empreendimento oferece apartamentos com 2 ou 3 dormitórios (1 suíte), de 71 a 91 m² privativos, com hall sofisticado e áreas de lazer.' },
]
...
<PropertySchema nome="Rocca Pietore Residencial" slug="rocca-pietore-centro-sideropolis-sc" construtora_slug="fontana" cidade="Siderópolis" uf="SC" bairro="Centro" descricao="Rocca Pietore Residencial — 2 ou 3 dormitórios (1 suíte), 71 a 91 m² privativos no Centro de Siderópolis/SC. Financiamento direto Fontana." imagem="https://xpkznaqgctfkoonqpcye.supabase.co/storage/v1/object/public/imoveis/capas/rocca-pietore-centro-sideropolis-sc.jpg" faq={FAQ_ITEMS} />

      
      <style>{`
        html { scroll-behavior: smooth; }
        .rc-eyebrow { font-size:11px; letter-spacing:0.07em; text-transform:uppercase; }
        .rc-h1 { font-family:${t.display}; font-weight:600; }
        .rc-h2 { font-family:${t.display}; font-weight:600; font-size:clamp(26px,4vw,46px); }
        .rc-cta { display:inline-block; border:1px solid; padding:16px 34px; text-decoration:none; }
      ...
      <section style={{ position:'relative', height:'100vh', minHeight:560, display:'flex', alignItems:'flex-end' }}>
        ...
        <div style={{ position:'relative', padding:'0 32px 64px', maxWidth:760 }}>
          ...
          <a href={WPP} target="_blank" rel="noopener noreferrer" className="rc-cta" style={{ color:'#fff', borderColor:'rgba(255,255,255,0.6)', fontSize:15 }}>
            Quero Saber Mais
          </a>
        </div>
      </section>
      ...
      <section style={{ padding:'96px 32px', maxWidth:1100, margin:'0 auto', display:'grid', gridTemplateColumns:'1fr 1fr', gap:64, alignItems:'center' }}>
        <div>
          ...
          <a href={WPP} target="_blank" rel="noopener noreferrer" className="rc-cta" style={{ color:t.navy, borderColor:t.navy, fontSize:15 }}>
            Consultar Condições
          </a>
        </div>
      ...
      <section style={{ background:t.dark, padding:'96px 32px' }}>
        <div style={{ maxWidth:900, margin:'0 auto', textAlign:'center' }}>
          ...
          <p style={{ color:t.onDarkMuted, fontSize:16, lineHeight:1.8, maxWidth:640, margin:'0 auto 48px' }}>
            As condições de pagamento do Rocca Pietore são definidas pela Construtora Fontana e variam conforme a unidade e a tabela vigente. Entrada, parcelas, reajustes, prazos e eventual aprovação devem ser confirmados antes da contratação.
          </p>
          <a href={WPP} target="_blank" rel="noopener noreferrer" className="rc-cta" style={{ color:t.onDark, borderColor:'rgba(245,242,237,0.4)', fontSize:15 }}>
            Consultar Condições
          </a>
        </div>
      </section>
      ...
      <section style={{ position:'relative', minHeight:480, display:'flex', alignItems:'center', justifyContent:'center', overflow:'hidden' }}>
        ...
        <div style={{ position:'relative', textAlign:'center', padding:'0 32px' }}>
          ...
          <p style={{ color:'rgba(255,255,255,0.75)', marginBottom:40, fontFamily:t.display, fontStyle:'italic', fontSize:18 }}>Preço sob consulta · Centro · Siderópolis / SC</p>
