...
// Hotsite premium Parco Savello Residencial (Fontana, Santa Barbara Criciuma/SC). Padrao EPIC.
...
const GALERIA: { src: string; alt: string; label: string }[] = [
  { src: 'https://estilofontana.com.br/images/empreendimento/slideshows/parco-savello-residencial-6644aab323ce3.jpg?fm=webp', alt: 'Parco Savello Residencial — perspectiva do empreendimento no bairro Santa Barbara', label: 'O Residencial' },
  ...
  { src: 'https://blog.estilofontana.com.br/wp-content/uploads/2024/06/lancamento-em-criciuma-parco-savello-1.jpg', alt: 'Parco Savello Residencial — acesso principal e jardins', label: 'Acesso Principal' },
  { src: 'https://www.estilofontana.com.br/blog/wp-content/uploads/2024/06/lancamento-em-Criciuma-parco-savello-4.jpg', alt: 'Parco Savello Residencial — torre residencial ao entardecer', label: 'Torre' },
  { src: 'https://www.estilofontana.com.br/blog/wp-content/uploads/2024/06/lancamento-em-Criciuma-parco-savello-3.jpg', alt: 'Parco Savello Residencial — perspectiva aerea e entorno', label: 'Entorno' },
  { src: 'https://www.estilofontana.com.br/blog/wp-content/uploads/2024/06/lancamento-em-Criciuma-parco-savello-6.jpg', alt: 'Parco Savello Residencial — espaco de lazer e areas comuns', label: 'Lazer' },
  { src: 'https://www.estilofontana.com.br/blog/wp-content/uploads/2024/06/lancamento-em-Criciuma-parco-savello-5-1.jpg', alt: 'Parco Savello Residencial — jardins e paisagismo', label: 'Paisagismo' },
] = [
...
const DIFERENCIAIS: string[] = [
  ...
  'Fechadura digital',
  'Persiana nos dormitorios',
  'Tubulacao para agua quente',
  'Rebaixo em gesso',
  'Espera para split',
  'Espera para coifa',
  'Espera para carregador eletrico',
  'Manta acustica entre pavimentos',
  'Possibilidade de personalizacao de planta',
]

const AMENIDADES: string[] = [
  'Piscina adulto e infantil',
  'Espaco gourmet externo',
  'Espaco fitness com terraco',
  'Salao de festas',
  'Brinquedoteca',
  'Playground',
  'Pet place',
...
export const metadata: Metadata = {
  title: 'Parco Savello Residencial | Santa Barbara Criciuma | Stiven Allan',
  description: 'Parco Savello Residencial (Construtora Fontana): 3 dormitorios (2 suites), 93 a 94 m², no bairro Santa Barbara, Criciuma/SC. Financiamento direto com a construtora. Atendimento exclusivo com Stiven Allan.',
  keywords: ['Parco Savello Residencial', 'apartamento Santa Barbara Criciuma', 'lancamento Fontana', 'Stiven Allan corretor SC'],
  ...
  openGraph: {
    ...
    description: 'Parco Savello Residencial (Construtora Fontana): 3 dormitorios (2 suites), 93 a 94 m², Santa Barbara Criciuma/SC. Financiamento direto Fontana.',
    url: `${SITE_URL}/empreendimento/fontana/parco-savello-santa-barbara-criciuma-sc`,
    images: [{ url: IMG.aerea, width: 1200, height: 630, alt: 'Parco Savello Residencial — vista aerea' }],
    type: 'website',
    locale: 'pt_BR',
  },
  twitter: {
    ...
    title: 'Parco Savello Residencial — Vivi la Vita',
    description: 'Parco Savello Residencial (Construtora Fontana): 3 dormitorios (2 suites), 93 a 94 m², Santa Barbara Criciuma/SC.',
    images: [IMG.aerea],
  },
  ...
  '@graph': [
    {
      ...
      areaServed: { '@type': 'City', name: 'Criciuma', containedInPlace: { '@type': 'State', name: 'Santa Catarina' } },
    },
    {
      '@type': 'Apartment',
      name: 'Parco Savello Residencial',
      description: 'Apartamentos no bairro Santa Barbara, Criciuma/SC: 3 dormitorios (2 suites), 93 a 94 m² privativos, 2 vagas, com financiamento direto com a Construtora Fontana.',
      image: IMG.hero,
      numberOfRooms: 3,
      numberOfBathroomsTotal: 2,
      floorSize: { '@type': 'QuantitativeValue', minValue: 93, maxValue: 94, unitCode: 'MTK' },
      address: { '@type': 'PostalAddress', streetAddress: 'Rua Duarte da Costa, 875', addressLocality: 'Criciuma', addressRegion: 'SC', addressCountry: 'BR' },
    },
    {
      '@type': 'BreadcrumbList',
      itemListElement: [
        { '@type': 'ListItem', position: 1, name: 'Inicio', item: SITE_URL },
        { '@type': 'ListItem', position: 2, name: 'Lancamentos Criciuma', item: `${SITE_URL}/lancamentos/criciuma-sc` },
  ...
  return (
    <main style={{ background: t.bg, color: t.ink, fontFamily: t.body, overflowX: 'hidden' }}>
      ...
      <header style={{ position: 'absolute', top: 0, left: 0, right: 0, zIndex: 50 }}>
        <nav style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '22px clamp(18px,5vw,56px)' }}>
          ...
          <div className="ps-nav-links" style={{ display: 'flex', alignItems: 'center', gap: 30 }}>
            ...
            <a href="#residencias" className="ps-navlink">As Residencias</a>
            <a href="#diferenciais" className="ps-navlink">Diferenciais</a>
            <a href="#localizacao" className="ps-navlink">Localizacao</a>
      ...
      <section id="top" style={{ position: 'relative', minHeight: '100vh', display: 'flex', alignItems: 'flex-end' }}>
        <Image src={IMG.hero} alt="Parco Savello Residencial — perspectiva do empreendimento no bairro Santa Barbara, Criciuma/SC" fill priority sizes="100vw" style={{ objectFit: 'cover', objectPosition: 'center' }} />
        ...
        <div className="ps-fade" style={{ position: 'relative', zIndex: 2, padding: '0 clamp(18px,5vw,56px) clamp(56px,9vh,110px)', maxWidth: 1100 }}>
          <p className="ps-eyebrow ps-onimg" style={{ color: '#fff', marginBottom: 18 }}>Parco Savello Residencial &mdash; Santa Barbara, Criciuma/SC</p>
      ...
      <section id="residencial" style={{ padding: 'clamp(80px,14vh,160px) clamp(18px,5vw,56px)', textAlign: 'center' }}>
        <div style={{ maxWidth: 820, margin: '0 auto' }}>
          ...
          <p className="ps-serif" style={{ fontSize: 'clamp(22px,3.2vw,38px)', lineHeight: 1.38, color: t.ink, margin: 0 }}>
            O Parco Savello Residencial nasce para quem valoriza a calmaria sem abrir mao da vida urbana.
          </p>
          <p style={{ fontSize: 18, lineHeight: 1.8, color: t.muted, marginTop: 28, maxWidth: 640, marginLeft: 'auto', marginRight: 'auto' }}>
            No coracao do bairro Santa Barbara, com o Parque da Prefeitura como extensao do seu quintal, cada dia e uma nova experiencia de bem-estar. Um lugar onde o tempo desacelera e a vida floresce.
          </p>
      ...
      <section id="galeria" style={{ padding: 'clamp(40px,8vh,80px) 0 0' }}>
        <div style={{ textAlign: 'center', padding: '0 clamp(18px,5vw,56px) clamp(34px,6vh,60px)' }}>
          ...
          <h2 className="ps-h2">Naturaleza<br />e elegancia</h2>
        </div>
      ...
      <section id="residencias" style={{ background: t.dark, color: t.onDark, padding: 'clamp(80px,14vh,160px) clamp(18px,5vw,56px)' }}>
        <div style={{ maxWidth: 1080, margin: '0 auto', textAlign: 'center' }}>
          <p className="ps-eyebrow" style={{ color: t.onDark, marginBottom: 18 }}>As Residencias</p>
          <h2 className="ps-h2" style={{ color: t.onDark }}>Espaco para viver com inteireza</h2>
          <p className="ps-serif" style={{ color: t.onDarkMuted, fontSize: 'clamp(18px,2.4vw,26px)', marginTop: 18, marginBottom: 56 }}>3 dormitorios, 2 suites, 2 vagas.</p>
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(180px, 1fr))', gap: 'clamp(28px,5vw,64px)', marginBottom: 56 }}>
            {[
              { n: '3', l: 'Dormitorios (2 suites)' },
          ...
          <a href={WPP} target="_blank" rel="noopener noreferrer" className="ps-cta ps-cta-light" data-wpp="1">Solicitar Catalogo</a>
        </div>
      </section>
      ...
      <section id="diferenciais" style={{ padding: 'clamp(80px,14vh,160px) clamp(18px,5vw,56px)' }}>
        <div style={{ maxWidth: 1120, margin: '0 auto' }}>
          <div style={{ textAlign: 'center', marginBottom: 'clamp(40px,7vh,72px)' }}>
            ...
            <h2 className="ps-h2">Cada detalhe<br />pensado para voce</h2>
          </div>
      ...
      <section style={{ background: t.bg, padding: 'clamp(80px,12vh,140px) clamp(18px,5vw,56px)' }}>
        <div style={{ maxWidth: 1180, margin: '0 auto' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'minmax(0,1.15fr) minmax(0,1fr)', gap: 'clamp(28px,5vw,64px)', alignItems: 'center' }}>
            <LightboxPhoto src={IMG.fachada} alt="Fachada do Parco Savello Residencial em Santa Barbara, Criciuma/SC" label="Fachada" cardClass="ps-lazer-card" imgSizes="(max-width: 768px) 100vw, 55vw" />
      ...
      <section id="localizacao" style={{ padding: 'clamp(80px,12vh,140px) clamp(18px,5vw,56px)', background: t.dark, color: t.onDark }}>
        <div style={{ maxWidth: 1180, margin: '0 auto' }}>
          <div style={{ maxWidth: 640 }}>
            <p className="ps-eyebrow" style={{ color: t.onDark, marginBottom: 18 }}>Localizacao</p>
            ...
            <p style={{ color: t.onDarkMuted, fontSize: 17, lineHeight: 1.6, marginTop: 0 }}>
              Rua Duarte da Costa, n&ordm; 875, esq. Rua Artur Bernardes &mdash; Santa Barbara, Criciuma/SC
            </p>
            <p style={{ color: t.onDarkMuted, fontSize: 15, lineHeight: 1.8, marginTop: 14, maxWidth: 420 }}>
              Tendo o bem-estar e a natureza como seus melhores vizinhos. O Parque da Prefeitura como extensao do seu quintal.
            </p>
      ...
      <section style={{ background: t.green, color: t.onDark, padding: 'clamp(80px,14vh,160px) clamp(18px,5vw,56px)' }}>
        <div style={{ maxWidth: 1080, margin: '0 auto', textAlign: 'center' }}>
          ...
          <p className="ps-serif" style={{ color: t.onDarkMuted, fontSize: 'clamp(18px,2.4vw,26px)', marginTop: 18, marginBottom: 60 }}>Sem burocracia, sem intermediarios. Direto com a construtora.</p>
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(240px,1fr))', gap: 'clamp(28px,4vw,52px)' }}>
            {[
              { n: '01', ti: 'Converse com o Corretor', d: 'Atendimento exclusivo e reservado com Stiven Allan para entender o seu momento e as melhores condicoes.' },
              { n: '02', ti: 'Condicoes sob medida', d: 'Proposta construida conforme o seu momento, sem intermediarios e sem amarras bancarias.' },
      ...
      <section style={{ position: 'relative', minHeight: '78vh', display: 'flex', alignItems: 'center', justifyContent: 'center', textAlign: 'center' }}>
        <Image src={IMG.aerea} alt="Vista aerea do Parco Savello Residencial em Santa Barbara, Criciuma/SC" fill loading="lazy" sizes="100vw" style={{ objectFit: 'cover' }} />
      ...
      <footer style={{ background: t.greenDark, color: t.onDarkMuted, padding: 'clamp(56px,9vh,96px) clamp(18px,5vw,56px)' }}>
        <div style={{ maxWidth: 1180, margin: '0 auto', display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(220px,1fr))', gap: 'clamp(28px,5vw,56px)' }}>
          <div>
            ...
            <p style={{ marginTop: 14, fontSize: 14, lineHeight: 1.6 }}>Imoveis de alto padrao em Santa Catarina.<br />CRECI 60.275</p>
          </div>
          <div>
          ...
          <div>
            ...
            <p style={{ fontSize: 14, lineHeight: 1.6, margin: 0 }}>Parco Savello Residencial<br />Construtora Fontana<br />Santa Barbara, Criciuma/SC</p>
          </div>
        </div>
