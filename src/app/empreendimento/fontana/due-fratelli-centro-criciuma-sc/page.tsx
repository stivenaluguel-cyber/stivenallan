...
const GALERIA = [
  ...
  { src: 'https://lh3.googleusercontent.com/d/1oYwiQgL0nRR_kszOGpvUuc8ZymStCUI7', alt: 'Dormitório Due Fratelli', label: 'Dormitório' },
  { src: 'https://lh3.googleusercontent.com/d/1qA0HsE4vSUI7-j6UFsJBD7dNEuZ1c4Q4', alt: 'Dormitório Due Fratelli', label: 'Dormitório' },
  { src: 'https://lh3.googleusercontent.com/d/1lUhstJvwxFyA9Vin2KhxU_Zf2sXsO2Nw', alt: 'Dormitório Due Fratelli', label: 'Dormitório' },
  { src: 'https://lh3.googleusercontent.com/d/1IatMUMVqUqr5ofMavFYJhRJjQ-QNV6A8', alt: 'Banheiro Due Fratelli', label: 'Banheiro' },
]

const DIFERENCIAIS = [
  '2 e 3 dormitórios com até 92 m² privativos',
...
export const metadata: Metadata = {
  ...
  description: 'Due Fratelli Residencial — 2 e 3 dormitórios com até 92 m² privativos no Centro de Criciúma/SC. Sacada com churrasqueira, 2 elevadores. Conheça com Stiven Allan.',
  ...
  openGraph: {
    ...
    description: 'Qualidade de vida e praticidade no Centro de Criciúma.',
    url: `${SITE_URL}/empreendimento/fontana/due-fratelli-centro-criciuma-sc`,
    images: [{ url: IMG.hero, width: 1200, height: 630, alt: 'Due Fratelli Residencial' }],
    type: 'website',
  },
  twitter: { card: 'summary_large_image', title: 'Due Fratelli Residencial | Centro Criciúma SC', description: 'Qualidade de vida e praticidade no Centro de Criciúma.', images: [IMG.hero] },
  ...
  '@graph': [
    {
      ...
      description: 'Residencial com 2 e 3 dormitórios de até 92 m² privativos no Centro de Criciúma/SC.',
      numberOfRooms: 3,
    ...
    <main style={{ background: t.bg, color: t.ink, fontFamily: t.body, margin: 0, padding: 0 }}>
      ...
      <style>{`
        ...
        *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
        ...
        .df-nav-links a{font-family:${t.body};font-size:13px;font-weight:400;color:${t.onDarkMuted};text-decoration:none;letter-spacing:0.5px;transition:color .2s;}
        .df-nav-links a:hover{color:${t.onDark}}
        .df-nav-cta{font-family:${t.body};font-size:13px;font-weight:500;color:${t.onDark};background:${t.slate};border:none;border-radius:6px;padding:9px 20px;cursor:pointer;text-decoration:none;letter-spacing:0.5px;transition:background .2s;}
        ...
        .df-btn-primary{font-family:${t.body};font-size:14px;font-weight:500;color:${t.onDark};background:${t.slate};border:none;border-radius:8px;padding:14px 28px;cursor:pointer;text-decoration:none;letter-spacing:0.5px;transition:background .2s;}
        .df-btn-primary:hover{background:${t.slateDark}}
        .df-btn-outline{font-family:${t.body};font-size:14px;font-weight:400;color:${t.onDark};background:transparent;border:1px solid rgba(232,239,246,0.35);border-radius:8px;padding:14px 28px;cursor:pointer;text-decoration:none;letter-spacing:0.5px;transition:border-color .2s;}
        ...
        .df-stat-l{font-family:${t.body};font-size:13px;font-weight:400;color:${t.muted};letter-spacing:0.5px;margin-top:4px;}
        ...
        .df-amenidade{font-family:${t.body};font-size:13px;font-weight:400;color:${t.onDark};background:rgba(232,239,246,0.08);border:1px solid rgba(232,239,246,0.15);border-radius:100px;padding:8px 20px;letter-spacing:0.5px;}
      ...
      <section className="df-hero">
        <div className="df-hero-img">
          <Image src={IMG.hero} alt="Due Fratelli Residencial — Fachada" fill style={{ objectFit:'cover' }} priority sizes="100vw" />
        </div>
        <div className="df-hero-content">
          <p className="df-hero-eyebrow">Construtora Fontana · Centro · Criciúma/SC</p>
          ...
          <div className="df-hero-actions">
            ...
            <a href={CATALOGO_PDF} className="df-btn-outline" target="_blank" rel="noopener noreferrer">Baixar catálogo</a>
          </div>
        </div>
      </section>
      ...
      <section className="df-section">
        <p className="df-section-eyebrow">As Residências</p>
        <h2 className="df-section-title">Espaço e sofisticação<br/>para a sua família</h2>
        <p className="df-section-text">Atento ao potencial de expansão da região, o Due Fratelli une a melhor seleção de serviços e lojas comerciais à tranquilidade do seu lar. Dar valor à sua vida é aproveitar e reservar mais tempo com quem você ama.</p>
        <div className="df-stats">
          {[{n:'2 e 3',l:'Dormitórios'},{n:'1',l:'Suíte'},{n:'até 92',l:'m² privativos'},{n:'2',l:'Elevadores'}].map(s => (
            <div key={s.l}>
      ...
      <section className="df-section" style={{ paddingTop: 0 }}>
        ...
        <GalleryWithLightbox
          galeria={GALERIA}
          prefix="df-"
          gradient="linear-gradient(to top,rgba(13,20,26,0.6) 0%,transparent 100%)"
        />
      </section>
      ...
      <section className="df-section">
        ...
        <div className="df-lazer-grid">
          <div className="df-lazer-main">
            <LightboxPhoto
              src={IMG.lazer}
              alt="Lazer Due Fratelli"
              label="Área de Lazer"
              cardClass="df-lazer-main"
              imgSizes="(max-width:640px) 100vw,50vw"
            />
          </div>
          <div className="df-lazer-sm">
            <LightboxPhoto
              src={GALERIA[8].src}
              alt="Salão de Festas Due Fratelli"
              label="Salão de Festas"
              cardClass="df-lazer-sm"
              imgSizes="(max-width:640px) 100vw,25vw"
            />
          </div>
          <div className="df-lazer-sm">
            <LightboxPhoto
              src={GALERIA[12].src}
              alt="Churrasqueira Due Fratelli"
              label="Churrasqueira"
              cardClass="df-lazer-sm"
              imgSizes="(max-width:640px) 100vw,25vw"
            />
      ...
      {/* LOCALIZAÇÃO */}
      <section className="df-section" style={{ paddingTop: 0 }}>
        <p className="df-section-eyebrow">Localização</p>
        <h2 className="df-section-title">No coração<br/>de Criciúma</h2>
        <p className="df-section-text">Rua Princesa Isabel — Centro, Criciúma/SC. Próximo a comércio, serviços e vias de acesso.</p>
        <div className="df-mapa-wrap">
          <Image src={IMG.mapa} alt="Localização Due Fratelli — Centro Criciúma" fill style={{ objectFit:'cover' }} sizes="(max-width:768px) 100vw,80vw" />
        </div>
      </section>
      ...
      <section className="df-dark">
        ...
        <h2 className="df-section-title">Preço sob consulta</h2>
        <p className="df-section-text">Entre em contato para conhecer as condições especiais disponíveis para o Due Fratelli Residencial.</p>
        <div style={{ marginTop: 36 }}>
          <a href={WPP} className="df-btn-primary" target="_blank" rel="noopener noreferrer">Consultar condições</a>
        </div>
      </section>
      ...
      <footer className="df-footer">
        <p>© {new Date().getFullYear()} Stiven Allan · Corretor de Imóveis · <a href="/">stivenallan.vercel.app</a></p>
        <p style={{ marginTop: 8 }}>CRECI SC · Due Fratelli Residencial · Centro, Criciúma/SC</p>
      </footer>
