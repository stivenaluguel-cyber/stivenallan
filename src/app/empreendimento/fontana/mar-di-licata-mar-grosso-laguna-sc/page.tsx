...
{[{n:'3',l:'Dormêtórios'},{n:'1',l:'Suíte'},{n:'120 a 122',l:'m² privativos'},{n:'Rooftop',l:'exclusivo'}].map((it,i)=>(
...
<p style={{ marginTop: 56, fontSize: 11, letterSpacing: '0.3em', textTransform: 'uppercase', color: t.onDark }}>Mar Grosso &middot; Laguna/SC &middot; Sob consulta</p>
</div>
</section>
...
<div style={{ maxWidth: 1180, margin: '40px auto 0', paddingTop: 24, borderTop: '1px solid rgba(226,238,246,0.12)', fontSize: 12 }}>&copy; {new Date().getFullYear()} Stiven Allan. Imagens meramente ilustrativas. Sob consulta.</div>
</footer>
