  ...
  '@graph': [
    {
      ...
      name: 'Villaggio Verde Residenziale',
      description: 'Condomínio fechado de terrenos de 794 a 1.038 m² na Grande Próspera, Criciúma/SC. 12.000 m² de área de lazer.',
      url: `${SITE_URL}/empreendimento/fontana/villaggio-verde-residenziale-grande-prospera-criciuma-sc`,
      image: CDN+'villaggio-verde-residenziale-646388473855e.JPG',
      address: {
        '@type': 'PostalAddress',
        streetAddress: 'Rodovia Leonardo Bialeck, 525',
        addressLocality: 'Criciúma',
        addressRegion: 'SC',
        addressCountry: 'BR',
      },
      offers: { '@type': 'Offer', availability: 'https://schema.org/InStock', priceCurrency: 'BRL', description: 'Sob consulta' },
    },
    {
      '@type': 'LocalBusiness',
