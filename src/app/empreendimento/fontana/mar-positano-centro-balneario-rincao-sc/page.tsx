...
const CONDICOES = {
  texto: 'Entrada de 20% do valor do imóvel, paga em parcela única, mais 6 reforços anuais (cada um equivalente a aproximadamente 5x o valor da parcela mensal), e o saldo dividido em 72 parcelas mensais. Durante a obra, os valores são corrigidos mensalmente pelo CUB/SC.',
