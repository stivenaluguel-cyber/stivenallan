...
export default function AvezzanoPage() {
  return (
    <main style={{ fontFamily: 'var(--font-public-sans), system-ui, sans-serif', color: '#1a1a1a', overflowX: 'hidden' }}>
      ...
      <section style={{ position: 'relative', height: '100vh', minHeight: '600px', overflow: 'hidden' }}>
        ...
        <div style={{ position: 'relative', zIndex: 2, height: '100%', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', textAlign: 'center', padding: '0 1.5rem' }}>
          <p style={{ color: ACCENT, fontSize: '0.75rem', letterSpacing: '0.07em', textTransform: 'uppercase', marginBottom: '1rem' }}>Centro · Siderópolis / SC</p>
          <h1 style={{ fontFamily: 'var(--font-piazzolla), Georgia, serif', color: '#fff', fontSize: 'clamp(2.5rem,6vw,5rem)', fontWeight: 600, lineHeight: 1.1, margin: '0 0 1.25rem', maxWidth: '800px' }}>
            Avezzano<br />Residencial
          </h1>
          <p style={{ fontFamily: 'var(--font-piazzolla), Georgia, serif', color: '#e8d5c0', fontSize: 'clamp(1.4rem,3vw,2.2rem)', fontStyle: 'italic', fontWeight: 400, marginBottom: '2rem' }}>
      ...
      <section id="o-residencial" style={{ background: '#faf9f7', padding: '6rem 1.5rem' }}>
        <div style={{ maxWidth: '860px', margin: '0 auto', textAlign: 'center' }}>
          <p style={{ color: ACCENT, fontSize: '0.7rem', letterSpacing: '0.07em', textTransform: 'uppercase', marginBottom: '1rem' }}>O Residencial</p>
          <div style={{ width: '40px', height: '2px', background: ACCENT, margin: '0 auto 2rem' }} />
          <h2 style={{ fontFamily: 'var(--font-piazzolla), Georgia, serif', fontSize: 'clamp(1.8rem,3.5vw,2.8rem)', fontWeight: 600, lineHeight: 1.3, marginBottom: '2rem', color: '#1a1a1a' }}>
            Inspirado na comune italiana de Avezzano
          </h2>
          ...
          <blockquote style={{ fontSize: 'clamp(1.1rem,1.6vw,1.3rem)', fontWeight: 500, color: '#333', borderLeft: `4px solid ${ACCENT}`, paddingLeft: '1.5rem', margin: '2.5rem auto', maxWidth: '600px', textAlign: 'left' }}>
            "Permita-se viver no melhor."
          </blockquote>
      ...
      <section id="galeria" style={{ padding: '5rem 1.5rem', background: '#111' }}>
        <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
          <p style={{ color: ACCENT, fontSize: '0.7rem', letterSpacing: '0.07em', textTransform: 'uppercase', textAlign: 'center', marginBottom: '0.75rem' }}>Galeria</p>
      ...
      <section id="as-residencias" style={{ background: '#1a1a1a', color: '#fff', padding: '6rem 1.5rem' }}>
        <div style={{ maxWidth: '1100px', margin: '0 auto', textAlign: 'center' }}>
          <p style={{ color: ACCENT, fontSize: '0.7rem', letterSpacing: '0.07em', textTransform: 'uppercase', marginBottom: '0.75rem' }}>As Residências</p>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: '2rem', marginBottom: '3rem' }}>
            {[
              ...
              <div key={l} style={{ padding: '2rem', border: '1px solid rgba(255,255,255,0.1)' }}>
                <p style={{ fontFamily: 'var(--font-piazzolla), Georgia, serif', fontSize: 'clamp(2.5rem,5vw,4rem)', fontWeight: 600, color: '#fff', margin: 0, lineHeight: 1 }}>{n}</p>
                <p style={{ fontSize: '0.8rem', color: 'rgba(255,255,255,0.55)', margin: '0.5rem 0 0' }}>{l}</p>
              </div>
            ))}
          </div>
          ...
          <div style={{ textAlign: 'left' }}>
            <p style={{ color: ACCENT, fontSize: '0.7rem', letterSpacing: '0.07em', textTransform: 'uppercase', textAlign: 'center', marginBottom: '2rem' }}>Plantas Oficiais</p>
      ...
      <section id="diferenciais" style={{ background: '#faf9f7', padding: '6rem 1.5rem' }}>
        <div style={{ maxWidth: '1100px', margin: '0 auto' }}>
          <p style={{ color: ACCENT, fontSize: '0.7rem', letterSpacing: '0.07em', textTransform: 'uppercase', textAlign: 'center', marginBottom: '0.75rem' }}>Diferenciais das Unidades</p>
          <div style={{ width: '40px', height: '2px', background: ACCENT, margin: '0 auto 3rem' }} />
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(260px, 1fr))', gap: '1.5rem' }}>
            {['1 suíte + 2 demi-suítes','Living amplo','Lavabo','Home office','Fechadura digital','2 elevadores','Churrasqueira'].map((item, i) => (
              <div key={item} style={{ background: '#fff', padding: '1.75rem 2rem', borderTop: `3px solid ${ACCENT}`, boxShadow: '0 2px 12px rgba(0,0,0,0.06)' }}>
                <span style={{ fontFamily: 'var(--font-piazzolla), Georgia, serif', fontSize: '2rem', color: ACCENT, fontWeight: 600, display: 'block', marginBottom: '0.5rem' }}>{String(i + 1).padStart(2, '0')}</span>
      ...
      <section id="lazer" style={{ background: '#111', color: '#fff', padding: '6rem 1.5rem' }}>
        <div style={{ maxWidth: '900px', margin: '0 auto', textAlign: 'center' }}>
          <p style={{ color: ACCENT, fontSize: '0.7rem', letterSpacing: '0.07em', textTransform: 'uppercase', marginBottom: '0.75rem' }}>Lazer & Áreas Comuns</p>
          <div style={{ width: '40px', height: '2px', background: ACCENT, margin: '0 auto 2.5rem' }} />
          <div style={{ display: 'flex', flexWrap: 'wrap', justifyContent: 'center', gap: '1rem' }}>
            {['Salão de festas','Playground','Churrasqueira'].map(item => (
              <span key={item} style={{ border: '1px solid rgba(255,255,255,0.2)', padding: '0.6rem 1.4rem', fontSize: '0.85rem', color: 'rgba(255,255,255,0.8)' }}>{item}</span>
            ))}
          </div>
        </div>
      </section>
      ...
      <section id="localizacao" style={{ padding: '6rem 1.5rem', background: '#fff' }}>
        <div style={{ maxWidth: '1100px', margin: '0 auto' }}>
          <p style={{ color: ACCENT, fontSize: '0.7rem', letterSpacing: '0.07em', textTransform: 'uppercase', textAlign: 'center', marginBottom: '0.75rem' }}>Localização</p>
          <div style={{ width: '40px', height: '2px', background: ACCENT, margin: '0 auto 2.5rem' }} />
          ...
          <div style={{ textAlign: 'center', marginTop: '2.5rem' }}>
            <a href={WA} target="_blank" rel="noopener"
              style={{ fontFamily: 'var(--font-public-sans), system-ui, sans-serif', background: ACCENT, color: '#fff', padding: '1rem 2.5rem', textDecoration: 'none', fontSize: '15px', fontWeight: 600, borderRadius: '2px', display: 'inline-block' }}>
              Agendar visita
            </a>
          </div>
        </div>
      ...
      <section id="catalogo" style={{ background: ACCENT, padding: '5rem 1.5rem', textAlign: 'center' }}>
        <div style={{ maxWidth: '700px', margin: '0 auto' }}>
          <p style={{ color: 'rgba(255,255,255,0.7)', fontSize: '0.7rem', letterSpacing: '0.07em', textTransform: 'uppercase', marginBottom: '1rem' }}>Material Completo</p>
          <h2 style={{ fontFamily: 'var(--font-piazzolla), Georgia, serif', color: '#fff', fontSize: 'clamp(1.8rem,3vw,2.5rem)', fontWeight: 600, marginBottom: '1rem' }}>
      ...
      <section id="financiamento" style={{ background: ACCENT_DARK, color: '#fff', padding: '6rem 1.5rem' }}>
        <div style={{ maxWidth: '900px', margin: '0 auto', textAlign: 'center' }}>
          <p style={{ color: 'rgba(255,255,255,0.6)', fontSize: '0.7rem', letterSpacing: '0.07em', textTransform: 'uppercase', marginBottom: '0.75rem' }}>Facilidade</p>
          <div style={{ width: '40px', height: '2px', background: 'rgba(255,255,255,0.4)', margin: '0 auto 2rem' }} />
          <h2 style={{ fontFamily: 'var(--font-piazzolla), Georgia, serif', fontSize: 'clamp(1.8rem,3vw,2.5rem)', fontWeight: 600, marginBottom: '1rem' }}>
            Financiamento Direto Fontana
          </h2>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: '2rem', marginBottom: '3rem' }}>
            {[
              ...
              <div key={n} style={{ padding: '2rem', background: 'rgba(255,255,255,0.07)', borderRadius: '2px' }}>
                <span style={{ fontFamily: 'var(--font-piazzolla), Georgia, serif', fontSize: '2.5rem', color: 'rgba(255,255,255,0.3)', fontWeight: 600 }}>{n}</span>
          ...
          <p style={{ fontSize: '0.75rem', color: 'rgba(255,255,255,0.5)', marginBottom: '0.5rem' }}>{COMERCIAL.vigencia}</p>
          <a href={WA} target="_blank" rel="noopener"
            style={{ display: 'inline-block', marginTop: '1.5rem', fontFamily: 'var(--font-public-sans), system-ui, sans-serif', background: '#fff', color: ACCENT_DARK, padding: '1rem 2.5rem', textDecoration: 'none', fontSize: '15px', fontWeight: 700, borderRadius: '2px' }}>
            Consultar condições
          </a>
        </div>
      </section>
      ...
      <EspelhoPublico slug="avezzano-centro-sideropolis-sc" />
      ...
      <section style={{ position: 'relative', height: '60vh', minHeight: '400px', overflow: 'hidden' }}>
        ...
        <div style={{ position: 'relative', zIndex: 2, height: '100%', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', textAlign: 'center', padding: '0 1.5rem' }}>
          <p style={{ fontFamily: 'var(--font-piazzolla), Georgia, serif', color: '#e8d5c0', fontSize: 'clamp(1.5rem,3vw,2.5rem)', fontStyle: 'italic', fontWeight: 400, marginBottom: '2rem' }}>
            "Permita-se viver no melhor."
          </p>
          <div style={{ display: 'flex', gap: '1rem', flexWrap: 'wrap', justifyContent: 'center' }}>
            ...
            <ShareButton nome="Avezzano Residencial" style={{ fontFamily: 'var(--font-public-sans), system-ui, sans-serif', background: 'transparent', color: '#fff', border: '1px solid rgba(255,255,255,0.6)', padding: '1rem 2.5rem', fontSize: '15px', fontWeight: 600, borderRadius: '2px', cursor: 'pointer' }} />
          </div>
        </div>
      </section>
      ...
      <footer style={{ background: '#0d0d0d', color: 'rgba(255,255,255,0.55)', padding: '3rem 1.5rem', textAlign: 'center' }}>
        <p style={{ fontFamily: 'var(--font-piazzolla), Georgia, serif', fontWeight: 600, color: '#fff', marginBottom: '0.5rem', fontSize: '1rem' }}>Stiven Allan</p>
