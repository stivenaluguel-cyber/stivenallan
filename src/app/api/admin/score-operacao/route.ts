 ...
 * supabase/migrations/20260805210000_score_operacao_agregados.sql) — um
 * round-trip só ao banco, sem N+1. O resultado calculado fica em memória
 * por 60s: é dado que muda devagar (interações da semana, unidades do
 * espelho) e não vale recalcular a cada refresh do dashboard.
 */
