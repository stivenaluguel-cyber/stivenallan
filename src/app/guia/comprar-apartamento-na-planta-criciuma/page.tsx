      ...
      <article style={{ maxWidth: 800, margin: '0 auto', padding: 'clamp(48px,8vh,96px) clamp(18px,5vw,64px)' }}>
        ...
        <div style={{ background: '#F0F7F0', borderRadius: 2, padding: '24px 28px', margin: '24px 0' }}>
          ...
          <ul style={{ fontSize: 14, lineHeight: 2, color: '#333', paddingLeft: 20, margin: 0 }}>
            ...
            <li><strong>Saldo (80%):</strong> R$ 400.000 dividido em parcelas mais reforços</li>
            <li><strong>Parcelas mensais base:</strong> aproximadamente R$ 3.330/mês por 72 meses</li>
            <li><strong>Reforços anuais (5x parcela):</strong> aproximadamente R$ 16.650/ano por 6 anos</li>
            <li><strong>Como chegamos a esses valores:</strong> a entrada de 20% sobre R$ 500.000 resulta em R$ 100.000, deixando um saldo de R$ 400.000 (80%). Diluído em 72 meses, o saldo daria cerca de R$ 5.556 por mês; como parte do valor migra para os 6 reforços anuais (cerca de R$ 16.650 cada), a parcela mensal base cai para aproximadamente R$ 3.330.</li>
          </ul>
        </div>
        <p style={{ fontSize: 16, lineHeight: 1.8, color: '#333' }}>
        ...
        <p style={{ fontSize: 16, lineHeight: 1.8, color: '#333', marginTop: 16 }}>
          Para imóveis de alto padrão, os bairros Michel e Centro de Criciúma concentram os lançamentos mais sofisticados, com apartamentos de 3 e 4 suítes, rooftops exclusivos e áreas de lazer completas. Para quem busca custo-benefício, os bairros Rio Maina e Santa Bárbara oferecem boas opções com financiamento direto acessível.
        </p>
