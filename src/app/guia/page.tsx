...
export default function GuiaIndexPage() {
    return (
        <main style={{ background: '#FAFAF8', color: '#1A1814', fontFamily: 'var(--font-public-sans), system-ui, sans-serif' }}>
            ...
            <section style={{ background: '#1A1814', color: '#F5F1EA', padding: 'clamp(64px,12vh,120px) clamp(18px,5vw,64px)' }}>
                <div style={{ maxWidth: 1080, margin: '0 auto' }}>
                    <p style={{ fontSize: 11, letterSpacing: '0.07em', textTransform: 'uppercase', color: 'rgba(245,241,234,0.55)', marginBottom: 20 }}>Central de Conteudo</p>
                ...
                <div style={{ maxWidth: 1080, margin: '0 auto' }}>
                    <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px,1fr))', gap: 28 }}>
                        {GUIAS.map((g) => (
                            ...
                            >
                                <h2 style={{ fontFamily: 'var(--font-piazzolla), Georgia, serif', fontWeight: 400, fontSize: 'clamp(17px,2vw,20px)', lineHeight: 1.3, margin: '0 0 12px', color: '#1A1814' }}>
                                    {g.titulo}
                                </h2>
                                <p style={{ fontSize: 14, lineHeight: 1.7, color: '#555', margin: '0 0 20px' }}>
                                    {g.resumo}
                                </p>
                                <span style={{ fontSize: 15, color: '#D24E22', fontWeight: 500 }}>
            ...
            <section style={{ padding: '0 clamp(18px,5vw,64px) clamp(72px,10vh,120px)' }}>
                <div style={{ maxWidth: 1080, margin: '0 auto' }}>
                    <div style={{ background: '#1A1814', color: '#F5F1EA', borderRadius: 2, padding: 'clamp(32px,5vw,56px)', textAlign: 'center' }}>
                        <h2 style={{ fontFamily: 'var(--font-piazzolla), Georgia, serif', fontWeight: 600, fontSize: 'clamp(20px,3vw,28px)', margin: 0 }}>Ainda tem duvidas?</h2>
