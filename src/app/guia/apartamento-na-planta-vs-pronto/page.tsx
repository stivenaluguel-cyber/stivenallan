                ...
                description: 'Entrada, desconto à vista, tempo de espera e personalização: as diferenças reais entre comprar em obra e comprar pronto.',
                    url: CANONICAL,
                        type: 'article',
                            ...
                            <Link href="/empreendimentos" style={{ fontSize: 15, color: '#1E8F76', textDecoration: 'none' }}>Ver Empreendimentos</Link>
                            </nav>
                            </header>
                            ...
                            <p style={{ fontSize: 11, letterSpacing: '0.07em', textTransform: 'uppercase', color: 'rgba(228,242,238,0.55)', marginBottom: 20 }}>Guia - Planta vs. Pronto</p>
                            ...
                            <h2 style={{ fontFamily: 'var(--font-piazzolla), Georgia, serif', fontWeight: 600, fontSize: 'clamp(20px,3vw,30px)', marginTop: 48, marginBottom: 16 }}>Os estágios reais dos empreendimentos da região</h2>
                            ...
                            <h2 style={{ fontFamily: 'var(--font-piazzolla), Georgia, serif', fontWeight: 600, fontSize: 'clamp(20px,3vw,30px)', marginTop: 48, marginBottom: 16 }}>Condições de pagamento por estágio</h2>
                            <p style={{ fontSize: 16, lineHeight: 1.8, color: '#333' }}>
                            ...
                            <h2 style={{ fontFamily: 'var(--font-piazzolla), Georgia, serif', fontWeight: 600, fontSize: 'clamp(20px,3vw,30px)', marginTop: 48, marginBottom: 16 }}>Tempo de espera e personalização</h2>
                            <p style={{ fontSize: 16, lineHeight: 1.8, color: '#333' }}>
                            ...
                            <h2 style={{ fontFamily: 'var(--font-piazzolla), Georgia, serif', fontWeight: 600, fontSize: 'clamp(20px,3vw,30px)', marginTop: 48, marginBottom: 16 }}>Financiamento disponível em cada fase</h2>
                            <p style={{ fontSize: 16, lineHeight: 1.8, color: '#333' }}>
                            ...
                            <h2 style={{ fontFamily: 'var(--font-piazzolla), Georgia, serif', fontWeight: 600, fontSize: 'clamp(20px,3vw,30px)', marginTop: 48, marginBottom: 16 }}>Vantagens de cada opção</h2>
                            ...
                            <h3 style={{ fontSize: 14, letterSpacing: '0.07em', textTransform: 'uppercase', color: '#1E8F76', marginTop: 0 }}>Na Planta</h3>
                            ...
                            <h3 style={{ fontSize: 14, letterSpacing: '0.07em', textTransform: 'uppercase', color: '#555', marginTop: 0 }}>Pronto</h3>
                            <ul style={{ fontSize: 14, lineHeight: 2, color: '#333', paddingLeft: 20, margin: 0 }}>
                            ...
                            <h2 style={{ fontFamily: 'var(--font-piazzolla), Georgia, serif', fontWeight: 600, fontSize: 'clamp(20px,3vw,30px)', marginTop: 48, marginBottom: 16 }}>Qual escolher?</h2>
                            <p style={{ fontSize: 16, lineHeight: 1.8, color: '#333' }}>
                            ...
                            <h2 style={{ fontFamily: 'var(--font-piazzolla), Georgia, serif', fontWeight: 600, fontSize: 'clamp(20px,3vw,28px)', margin: 0 }}>Encontre o estágio ideal para você</h2>
                            ...
                            <a href={WPP} target="_blank" rel="noopener noreferrer" style={{ display: 'inline-block', fontSize: 15, color: '#E4F2EE', border: '1px solid rgba(228,242,238,0.55)', padding: '14px 28px', textDecoration: 'none' }}>
                            Falar no WhatsApp
                            </a>
                            <Link href="/empreendimentos" style={{ display: 'inline-block', fontSize: 15, color: '#E4F2EE', border: '1px solid rgba(228,242,238,0.55)', padding: '14px 28px', textDecoration: 'none' }}>
                            Ver Empreendimentos
                            </Link>
                            </div>
                            </div>
