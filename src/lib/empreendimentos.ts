...
export const EMPREENDIMENTOS: Empreendimento[] = [
  ...
  { slug: 'hub-smart-home-criciuma-sc', nome: 'Hub Smart Home', construtoraSlug: 'fontana', cidade: 'Criciúma', bairro: 'Centro', uf: 'SC', imagem: 'https://xpkznaqgctfkoonqpcye.supabase.co/storage/v1/object/public/imoveis/capas/hub-smart-home-criciuma-sc.jpg', oculto: true },
  { slug: 'lavis-centro-criciuma-sc', nome: 'Lavis Residencial', construtoraSlug: 'fontana', cidade: 'Criciúma', bairro: 'Centro', uf: 'SC', imagem: 'https://xpkznaqgctfkoonqpcye.supabase.co/storage/v1/object/public/imoveis/capas/lavis-centro-criciuma-sc.jpg' },
  { slug: 'lavis-residencial-centro-criciuma-sc', nome: 'Lavis Residencial', construtoraSlug: 'fontana', cidade: 'Criciúma', bairro: 'Centro', uf: 'SC', imagem: 'https://xpkznaqgctfkoonqpcye.supabase.co/storage/v1/object/public/imoveis/capas/lavis-residencial-centro-criciuma-sc.jpg', oculto: true },
